...
nmscott@login-02 ~/cs2600/project2 $ gcc chat_server.c -lpthread && ./a.out
Listening on port 3264 for clients...
one
two
hi
leo
...
yo
^C
nmscott@login-02 ~/cs2600/project2 $ vim chat_server.c
nmscott@login-02 ~/cs2600/project2 $ gcc chat_server.c -lpthread && ./a.out
Listening on port 3264 for clients...
one
two
...
nmscott@login-02 ~/cs2600/project2 $ cat chat_server.c
#include <stdio.h>
#include <sys/socket.h>
#include <unistd.h>
#include <sys/types.h>
